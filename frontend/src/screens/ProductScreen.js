...
import { listProductDetails, createProductReview, resetProduct } from '../actions/productActions';
...
const ProductScreen = ({ history, match }) => {
    ...
    useEffect(() => {
        ...
        if (successProductReview ||errorProductReview) {
            const message = errorProductReview ? errorProductReview : "Review Submitted"
            alert(message);
            setRating(0);
            setComment('');
            ...
            : (
                <>
                    ...
                    <Row>
                        <Col md={6}>
                            <h2>Reviews</h2>
                            {product.reviews && product.reviews.length === 0 && <Message variant="warning">No Reviews</Message>}
                            <ListGroup variant="flush">
